...
async def get_buying_list(message):
    for i in range(4):
        await message.answer_photo(types.FSInputFile(path=f"p{i+1}.png"), f"Название: Product{i+1} | Описание: описание {i+1} | Цена: {(i+1) * 100}")
...
if __name__ == "__main__":
    ...
    loop.run_until_complete(send_cycle())
