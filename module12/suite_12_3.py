...
r_and_tTS.addTest(unittest.TestLoader().loadTestsFromTestCase(tests_12_1.RunnerTest))
r_and_tTS.addTest(unittest.TestLoader().loadTestsFromTestCase(tests_12_2.TournamentTest))
